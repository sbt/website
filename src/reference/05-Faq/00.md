...
The name sbt is recursive for the "sbt build tool".  However, it is no longer acknowledged as an [initialism][],
so it is just "sbt", and should be written in all lowercase letters.
