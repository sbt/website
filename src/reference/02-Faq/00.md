...
In $app_version$, declare the specific type of dependency you want. Read
...
#### Where did class/object X go since 0.7?
  ...
  0.7                                                                                                                                                                                              $app_version$
  ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ ---------------------------------------------------------------------------------------------------------------------
  | [FileUtilities](http://simple-build-tool.googlecode.com/svn/artifacts/latest/api/sbt/FileUtilities\$object.html)                                                                             `IO <../api/sbt/IO\$.html>`\_
  [Path class](http://simple-build-tool.googlecode.com/svn/artifacts/latest/api/sbt/Path.html) and [object](http://simple-build-tool.googlecode.com/svn/artifacts/latest/api/sbt/Path\$.html)   \_ `Path object <../api/sbt/Path\$.html>`\_, `File`, `RichFile <../api/sbt/RichFile.html>`\_
  [PathFinder class](http://simple-build-tool.googlecode.com/svn/artifacts/latest/api/sbt/PathFinder.html)                                                                                      `Seq[File]`, `PathFinder class <../api/sbt/PathFinder.html>`\_, `PathFinder object <../api/sbt/PathFinder\$.html>`\_
