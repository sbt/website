...
#### Where did class/object X go since 0.7?
  ...
  [Path class](http://simple-build-tool.googlecode.com/svn/artifacts/latest/api/sbt/Path.html) and [object](http://simple-build-tool.googlecode.com/svn/artifacts/latest/api/sbt/Path\$.html)   \_ [Path object](../api/sbt/Path\$.html), `File`, [RichFile](../api/sbt/RichFile.html)
