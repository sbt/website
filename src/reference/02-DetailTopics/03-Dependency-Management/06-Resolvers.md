...
-   `JCenter` This is the Bintray JCenter repository at
    <http://jcenter.bintray.com/>
-   `BintrayMavenRepository` This is the Bintray repository at
     <http://dl.bintray.com/[subject]/[repo]/>, requires two arguments - `subject` and `repo`    
